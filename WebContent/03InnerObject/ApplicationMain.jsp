...
엘리먼트를 통해 등록하게 된다. 이를 컨텍스트 초기화 파라미터 라고 한다.
 --%>
	...
	<%--ServletContext : application객체의 자료형(javax.servlet.ServletContext) --%>
	...
	사용해야한다.
	*/
	String getRealPaht(ServletContext app1){
	...
	<ul>
		...
		<li>매개변수로 전달 : <%=getRealPaht(application) %></li>
		<%
		this.app2= application;
		%>
		<li>맴버변수 : <%=getRealPathString() %></li>
	</ul>
