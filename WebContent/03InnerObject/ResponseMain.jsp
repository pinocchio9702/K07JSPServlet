...
*/
//HTTP/1.0에서 적용하때 사용(현재는 사용하지 않지만 호환성을 위해 남겨둠)
...
/*
파일 다운로드 구현시 사용
	: 웨브라우저가 인식하지 못하는 MIME타입으로 설정하면
	웹브라우저는 파일 다운로드창을 통해 파일을 다운로드 시켜버린다.
	jpg와 같은 이미지 파일은 웹브라우저가 인식하는MIME타입으므로 
...
*/
	...
	response.addIntHeader("numberOfCrew", 99);//기존헤더 덮어쓰기 (수정) -> 99만 출력
