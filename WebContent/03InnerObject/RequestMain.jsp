	...
	*/
	...
	<form method="post" name="regFrm" action="RequestParameter.jsp" onsubmit="return checkForm(this);">
		...
		관심사항 : 
			...
			<input type="checkbox" name="favorite" value="ecomoic"  />경제
			<input type="checkbox" name="favorite" value="politics" />정치
			
		<br />
		성별 : 
			<input type="radio" name="sex" value="man" />남자
			<input type="radio" name="sex" value="checked" />여자
		<br />
		자기소개 : 
		<textarea name="self_intro" cols="30" rows="10">
			나는 부유한 집안에서 태어나서 대충 살아습니다.
			<!-- textarea는 태그와 태그 사이에 컨텐츠가 들어가므로 정렬을
				위해 줄바꿈을 사용하게 되면 필요없는 공백이 포함될수 있으므로 
				주의해야 한다. 
			-->
		</textarea>
