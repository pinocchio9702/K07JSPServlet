...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    모든 타입의 객체를 저장할 수 있다. Object타입으로 자동 형변환되어
    ...
    */
    	...
    	pageContext.setAttribute("pageMember2", new MemberDTO("namkung", "1234", "남궁학생",null));
...
<body>
	...
	*/
	...
	String m1Str = String.format("아이디 : %s, 비번:%s, 이름 :%s, 가입일: %s", m1.getId(), m1.getPass(),m1.getName(), m1.getRegidate());
	...
	<%--
		...
		사용하는 경우 같은 페이지로 취급되어 페이징영역이 공유된다.
	 --%>
