			...
			<div class="col-9 pt-3">
				...
				<div class="row mb-3">
					...
					<!-- 
						what is param???
					 -->
						<button type="button" class="btn btn-secondary" onclick="location.href='./DataPassword?idx=${param.idx}&mode=edit&nowPage=${param.nowPage }';">수정하기</button>
						<button type="button" class="btn btn-success" onclick="location.href='./DataPassword?idx=${dto.idx}&mode=delet&nowPage=${param.nowPage }';">삭제하기</button>
					...
					<div class="col-6 text-right pr-5">
						<button type="button" class="btn btn-warning"
							onclick="location.href='./DataList?idx=${param.nowPage}';">리스트보기</button>
					</div>
				</div>
