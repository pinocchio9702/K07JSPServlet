...
<body>
	<fieldset>
		...
		<!-- 
			EL에서 속성에 접근시 -이 포함된 경우에는 .으로 표현할수 없고
			반드시 [ 를 통해 표현해야 한다.
		 -->
		...
		*/
		...
		<!-- 
			...
			배열이나 컬렉션의 크기만큼 반복하는 확장 for문 형태로 기술되었다.
		 -->
		...
		<h2>없는 속성이거나, 속성은 존재하지만 getter 가 없는 경우(자바빈)</h2>
		<%
		...
		<h2>EL의 내장객체중 사용자가 정의한 속서엥 접근하는 
			내장객체 및 맵 컬렉션인 경우</h2>
		
		<%
		request.setAttribute("reqProperty", "리쿼스트 영역저장");
		Map map = new HashMap();
